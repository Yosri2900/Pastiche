...
public class Pastiche {
  ...
  private static class Match implements Comparable<Match> {
    ...
    private String first, firstFile;
    private String second, secondFile;
    ...
    private Match(double score, String first, String second) {
      ...
      this.first = first;
      this.second = second;
      File f1 = new File(this.first);
      File f2 = new File(this.second);

      this.firstFile = f1.getName();
      this.secondFile = f2.getName();
    ...
    public int compareTo(Match other) {
      if (score > other.score) { // reverse order!
        ...
        return this.firstFile.compareTo(this.secondFile);
      } else {
        return 1;
      }
    }
    ...
    public String toString() {
      return String.format("%.2f", score * 100.0)+"%, "+this.firstFile+", "+this.secondFile;
    }
